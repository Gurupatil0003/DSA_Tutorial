...
|-----|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **1** | A1(1,7)  | A1(1,8)  | A1(1,9)  | A1(1,10) | A1(1,11) | A1(1,12) | A1(1,13) | A1(1,14) |
| **2** | A1(2,7)  | A1(2,8)  | A1(2,9)  | A1(2,10) | A1(2,11) | A1(2,12) | A1(2,13) | A1(2,14) |
| **3** | A1(3,7)  | A1(3,8)  | A1(3,9)  | A1(3,10) | A1(3,11) | A1(3,12) | A1(3,13) | A1(3,14) |
| **4** | A1(4,7)  | A1(4,8)  | A1(4,9)  | A1(4,10) | A1(4,11) | A1(4,12) | A1(4,13) | A1(4,14) |
| **5** | A1(5,7)  | A1(5,8)  | A1(5,9)  | A1(5,10) | A1(5,11) | A1(5,12) | A1(5,13) | A1(5,14) |
| **6** | A1(6,7)  | A1(6,8)  | A1(6,9)  | A1(6,10) | A1(6,11) | A1(6,12) | A1(6,13) | A1(6,14) |
| **7** | A1(7,7)  | A1(7,8)  | A1(7,9)  | A1(7,10) | A1(7,11) | A1(7,12) | A1(7,13) | A1(7,14) |
| **8** | A1(8,7)  | A1(8,8)  | A1(8,9)  | A1(8,10) | A1(8,11) | A1(8,12) | A1(8,13) | A1(8,14) |
